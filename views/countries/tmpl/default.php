...
<div class="row-fluid">
	<div class="span6 center">
		...
		<?php foreach ($periods as $period) : ?>
			...
			<div id="countries_<?php echo $period; ?>_value" style="height: 300px; width: 100%;"></div>
		<?php endforeach; ?>
	</div>
	<div class="span6 center">
		...
		<?php foreach ($periods as $period) : ?>
			<h3><?php echo $period == 'total' ? ucfirst($period) : 'Last ' . $period; ?></h3>
			<div id="countries_<?php echo $period; ?>_count" style="height: 300px; width: 100%;"></div>
		<?php endforeach; ?>
	</div>
</div>
